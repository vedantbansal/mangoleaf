...
def plot_hist(hist):
    ...
    plt.grid()
    plt.savefig('InceptionResNetV2_acc',dpi=300)
    plt.show()
...
model.save('InceptionResNetV2_detect.h5')
plot_hist(hist)
...
with open('InceptionResNetV2History','wb') as f:
    pickle.dump(hist.history,f)

df = pd.DataFrame.from_dict(hist.history)
df.to_csv('InceptionResNetV2_history.csv')
